...
const es = {
  ...
  form: {
    ...
    ubicacionLabel: "Ubicación (opcional, para el mapa)",
    lat: "Latitud",
    lon: "Longitud",
    latPlaceholder: "ej. 40.4168",
    lonPlaceholder: "ej. -3.7038",
    usarMiUbicacion: "Usar mi ubicación",
    obteniendoUbicacion: "Obteniendo…",
    ubicacionNoDisponible: "No se pudo obtener la ubicación del dispositivo.",
    quitarUbicacion: "Quitar",
  },
  nav: {
    abrirMenu: "Abrir menú",
    cerrarMenu: "Cerrar menú",
    abrirChat: "Abrir asistente",
    cerrarChat: "Cerrar asistente",
  },
  results: {
    heading: "Resultado",
    categoria: "Categoría",
...
const en = {
  ...
  form: {
    ...
    ubicacionLabel: "Location (optional, for the map)",
    lat: "Latitude",
    lon: "Longitude",
    latPlaceholder: "e.g. 40.4168",
    lonPlaceholder: "e.g. -3.7038",
    usarMiUbicacion: "Use my location",
    obteniendoUbicacion: "Getting location…",
    ubicacionNoDisponible: "Couldn't get the device's location.",
    quitarUbicacion: "Remove",
  },
  nav: {
    abrirMenu: "Open menu",
    cerrarMenu: "Close menu",
    abrirChat: "Open assistant",
    cerrarChat: "Close assistant",
  },
  results: {
    heading: "Result",
    categoria: "Category",
